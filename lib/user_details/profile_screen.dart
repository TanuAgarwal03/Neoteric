                          ...
                          child: CircleAvatar(
                            ...
                            child: image != null?ClipRRect(
                              borderRadius: BorderRadius.circular(100),
                                child: Image.file(File(image!.path),fit: BoxFit.cover, height: 100,
                                  width: 100,)):
                                HomeProvider.homeSharedInstanace.profileImage != null?ClipRRect(
                                  borderRadius: BorderRadius.circular(100),
                                  child: Image.network(
                                    HomeProvider.homeSharedInstanace.profileImage.toString(),
                                    fit: BoxFit.cover, height: 100,
                                    width: 100,),
                                )
                                  :Padding(
                              padding: const EdgeInsets.all(10.0),
                              child: addText(getInitials(), Colors.white, 30, FontWeight.bold),
                            ),
                          ),
                        ),
                        Positioned(bottom: 1,right: 10,child: InkWell(
                          onTap: ()async{
                            ...
                            if(image != null)
                              {
                                showLoader(context);
                                try{
                                 await HomeProvider.homeSharedInstanace.uploadImage(File(image!.path));
                                 Navigator.pop(context);
                                }catch(e){
                                  Navigator.pop(context);
                                }
                          ...
                          child: Container(
                            ...
                            decoration: BoxDecoration(
                              ...
                              child: Image.asset("assets/edit.png",height: 10,width: 10,scale: 1,fit: BoxFit.scaleDown,)),
                        ),),
                      ],
                    ),
                    const SizedBox(height: 15,),
                    addAlignedText(name??"",const Color(0xFF303030),18,FontWeight.w600),
                    const SizedBox(height: 15,),
                    Row(
                      mainAxisAlignment: MainAxisAlignment.center,
                      children: [
                        Image.asset("assets/coin.png",scale: 1,height: 10,width: 10,),
                        addText("SIGNATURE MEMBER",const Color(0xFF505050),10,FontWeight.w500),
                      ],
                    ),
                  ],
                ),
            ...
            Padding(
              ...
              child: Column(
                children: [
                    ...
                    child: Container(
                      ...
                      child: Row(
                        children: [
                          ...
                          const SizedBox(width: 15,),
                          addText("Account Details", const Color(0xFF303030), 16, FontWeight.w500)
                        ],
                      ),
                    ),
                  ),
                  ...
                  InkWell(
                    onTap: (){
                      pushTo(context, PaymentScreen(isPaymentDetail: false,));
                    },
                    child: Container(
                      decoration: BoxDecoration(
                          border: Border.all(width: 0.2),
                      ...
                      child: Row(
                        children: [
                          ...
                          const SizedBox(width: 15,),
                          addText("Payments Details", const Color(0xFF303030), 16, FontWeight.w500)
                        ],
                      ),
                    ),
                  ),
                    ...
                    child: Container(
                      ...
                      child: Row(
                        children: [
                          ...
                          const SizedBox(width: 15,),
                          addText("Referral and Loyalty Program", const Color(0xFF303030), 16, FontWeight.w500)
                        ],
                      ),
                    ),
                  ),
                    ...
                    child: Container(
                      ...
                      child: Row(
                        children: [
                          ...
                          const SizedBox(width: 15,),
                          addText("Help", const Color(0xFF303030), 16, FontWeight.w500)
                        ],
                      ),
                    ),
                  ),
                  const SizedBox(height: 15,),
                  InkWell(child: addText("Log out", const Color(0xFFFF3500), 16, FontWeight.w600),
                  onTap: ()async{
