...
class _PropertiesDetailsState extends State<PropertiesDetails>
  ...
  void initState() {
    ...
    if (widget.viewAllPropertiesModel.temple != null &&
        widget.viewAllPropertiesModel.temple!.isNotEmpty &&
        widget.viewAllPropertiesModel.temple.toString().toLowerCase() ==
            "yes") {
      propertyamentiesDetails.add({
    ...
    if (widget.viewAllPropertiesModel.evcharging != null &&
        ...
        widget.viewAllPropertiesModel.evcharging.toString().toLowerCase() ==
            "yes") {
      propertyamentiesDetails.add({
    ...
    if (widget.viewAllPropertiesModel.healthcare != null &&
        ...
        widget.viewAllPropertiesModel.healthcare.toString().toLowerCase() ==
            "yes") {
      propertyamentiesDetails.add({
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: addAlignedText(
            'Property Details', Colors.black, 14, FontWeight.w600),
        actions: const [
          Row(
            children: [
              WhatsappIcon(),
      ...
      body: ListView(
        children: [
          Image.network(
            widget.viewAllPropertiesModel.projectData?.image ?? "",
            fit: BoxFit.cover,
          ),
          Padding(
                  ...
                  children: [
                    Expanded(
                      child: Column(
                        ...
                        children: [
                          addText(
                              widget.viewAllPropertiesModel.projectData?.name ??
                                  "",
                          ...
                          Row(
                            children: [
                              ...
                              Flexible(
                                  child: addText(
                                      "${widget.viewAllPropertiesModel.location ?? ""} | ",
                                      const Color(0xFF797979),
                                      10,
                                      FontWeight.w500)),
                              InkWell(
                                  onTap: () async {
                                    if (await launch(widget
                                        .viewAllPropertiesModel.location_link
                                        .toString())) {
                          ...
                          InkWell(
                            child: addText("View Payment Details >",
                                const Color(0xFFFF633A), 14, FontWeight.bold),
                            onTap: () {
                              pushTo(
                                  context,
                                  PaymentScreen(
                    ...
                    if (widget.viewAllPropertiesModel.virtual_tour != null)
                      InkWell(
                        onTap: () async {
                          if (await launch(widget
                              .viewAllPropertiesModel.virtual_tour
                              .toString())) {
                            throw Exception('Could not launch');
                          }
                        },
            ...
            child: Padding(
              ...
              child: Column(
                ...
                children: [
                    ...
                    itemBuilder: (context, index) {
                      ...
                      return Column(
                        children: [
                          ...
                          addText(property['title'], const Color(0xFF404040),
                              10, FontWeight.normal),
                          const SizedBox(
                            height: 5,
                          ),
                          addText(property['value'] ?? '',
                              const Color(0xFF404040), 12, FontWeight.normal),
                        ],
                      );
                    },
                  ),
                  ...
                  Padding(
                    padding: const EdgeInsets.all(8.0),
                    child: addText("Amenities", const Color(0xFF303030), 20,
                        FontWeight.w600),
                  ),
                  const SizedBox(
                    height: 10,
                    ...
                    itemBuilder: (context, index) {
                      ...
                      return Column(
                        children: [
                          ...
                          addAlignedText(property['title'],
                              const Color(0xFF1b1b1b), 10, FontWeight.normal),
                        ],
                      );
                    },
                  ),
          ...
          Visibility(
            ...
            child: Padding(
              ...
              child: Column(
                crossAxisAlignment: CrossAxisAlignment.start,
                children: [
                  addText("Property Photos", const Color(0xFF303030), 16,
                      FontWeight.w600),
                  SizedBox(
                    height: 250,
                    child: ListView.builder(
                      itemCount: widget.viewAllPropertiesModel.projectData
                              ?.propertyPhotos
                              .split(",")
                              .length ??
                          0,
                      ...
                      itemBuilder: (context, index) {
                        final service = widget
                            .viewAllPropertiesModel.projectData?.propertyPhotos
                            .split(",")[index];
                        return Row(
                          children: [
                            SizedBox(
                              ...
                              child: ClipRRect(
                                  ...
                                  child: Image.network(service.toString(),
                                      fit: BoxFit.cover,
                  ...
                  addText("Construction Upadates", const Color(0xFF303030), 16,
                      FontWeight.w600),
                  SizedBox(
                    height: 250,
                    child: ListView.builder(
                      itemCount: widget.viewAllPropertiesModel.projectData
                              ?.constructionUpadates
                              .split(",")
                              .length ??
                          0,
                      shrinkWrap: true,
                      scrollDirection: Axis.horizontal,
                      itemBuilder: (context, index) {
                        final service = widget.viewAllPropertiesModel
                            .projectData?.constructionUpadates
                            .split(",")[index];
                        return Row(
                          children: [
                            SizedBox(
                              ...
                              child: ClipRRect(
                                  borderRadius: BorderRadius.circular(15),
                                  child: service.toString().contains("youtube")
                                      ? YouTubeVideoPlayer(
                                          url: service.toString())
                                      : Image.network(service.toString(),
                                          height: 200,
                                          fit: BoxFit.cover,
                                          width:
